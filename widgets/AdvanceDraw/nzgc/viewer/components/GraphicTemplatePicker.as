...
package widgets.AdvanceDraw.nzgc.viewer.components
{
	...
	import widgets.AdvanceDraw.nzgc.viewer.events.GraphicTemplateEvent;
	import widgets.AdvanceDraw.nzgc.viewer.events.GraphicTemplatePickerEvent;
	import widgets.AdvanceDraw.nzgc.viewer.skins.GraphicTemplatePickerSkin;

	[Event(name="selectedTemplateChange", type="widgets.AdvanceDraw.nzgc.viewer.events.GraphicTemplateEvent")]
	[Event(name="templateListChange", type="widgets.AdvanceDraw.nzgc.viewer.events.GraphicTemplatePickerEvent")]
	[Event(name="organiseModeChange", type="widgets.AdvanceDraw.nzgc.viewer.events.GraphicTemplatePickerEvent")]
	...
	public class GraphicTemplatePicker extends SkinnableComponent
	{
		...
		private function newTemplate_SaveNewHandler(event:Event):void
		{
			...
			if (dialog.NewTemplate)
			{
				...
				Alert.show("New Template Added","Template");
