/*
    Created as part of the geoapps project http://code.google.com/p/geoapps/

    This code is released under the terms of the GNU Lesser General Public License;
    a copy of the license is in file lgpl.txt.
...
public class SpotlightTool extends BaseTool
{
	...
	[Embed(source="/assets/images/custom/spotlight/spotlight.png")]
	private var _spotlightIcon:Class;

	[Embed(source="/assets/images/custom/spotlight/spacer.gif")]
